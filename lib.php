 ...
 */
function block_scheduledcontent_pluginfile($course, $cm, $context, $filearea, $args, $forcedownload, array $options=array()) {
    $areas = array('showonpage', 'showinmodal');
    ...
    */
    ...
    $fs = get_file_storage();
    $file = $fs->get_file($context->id, 'block_scheduledcontent', $filearea, $itemid, $filepath, $filename);
    if (!$file) {
